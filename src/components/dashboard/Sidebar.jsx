...
const Sidebar = ({ onLogout }) => {
  ...
  return (
    <div 
      className={`bg-gray-900 text-white transition-all duration-300 h-screen sticky top-0 ${
        collapsed ? 'w-20' : 'w-64'
      }`}
    >
      ...
      <div className="py-4">
        ...
        <div className="mt-auto pt-4 border-t border-gray-800">
          <div className={`px-4 ${collapsed ? 'text-center' : ''}`}>
            <button
              onClick={onLogout}
              className={`flex items-center py-3 px-4 rounded-lg text-gray-400 hover:bg-gray-800 hover:text-white transition-colors ${
